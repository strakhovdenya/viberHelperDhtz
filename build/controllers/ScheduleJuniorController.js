...
var ScheduleJuniorController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, schedule_yanger_1.ScheduleJunior.bulkWrite(ops, { ordered: false })];
                    case 2:
                        result = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, schedule_yanger_1.ScheduleJunior.distinct('year_month')];
                    case 1:
                        result = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, schedule_yanger_1.ScheduleJunior.deleteMany({ year_month: yearMonth })];
                    case 2:
                        result = _a.sent();
                        if (result.ok === 1) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, schedule_yanger_1.ScheduleJunior.find({ year_month: yearMonth })];
                    case 2:
                        result = _a.sent();
                        res.json({ data: result });
                        return [3 /*break*/, 4];
    ...
    __decorate([
        decorators_1.get('/junior/months'),
        decorators_1.use(passport_1.default.authenticate('jwt', { session: false })),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", Promise)
    ...
    __decorate([
        decorators_1.del('/junior/months/:yearMonth'),
        decorators_1.use(passport_1.default.authenticate('jwt', { session: false })),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", Promise)
    ...
    __decorate([
        decorators_1.get('/junior/:yearMonth'),
        decorators_1.use(passport_1.default.authenticate('jwt', { session: false })),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", Promise)
