...
var devConnection = process.env.DB_MONGO_STRING;
// Connect to the correct environment database
var runMongo = function () { return __awaiter(void 0, void 0, void 0, function () {
    var e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                // @ts-ignore
                return [4 /*yield*/, mongoose_1.default.connect(devConnection, {
            ...
            case 2:
                e_1 = _a.sent();
                console.log("MongoDB Error: " + e_1.message);
                return [3 /*break*/, 3];
